...
api := r.Group("")
{
	...
	// ======================================= PAYMENT
	protected.GET("/payment", payment.ListPayments)
	protected.GET("/payment/:id", payment.GetPayment)
	protected.GET("/payment/user/:id", payment.ListPaymentByUID)
	...
	protected.GET("/services/user/:id", service.ListServicesByUID)
